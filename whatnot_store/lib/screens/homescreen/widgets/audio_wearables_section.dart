...
class AudioWearablesSection extends StatelessWidget {
  const AudioWearablesSection({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> allowedCategories = ["TWS"];
...
// ✅ 1. Try ALL variants (not just first)
...
if (imageUrl == null && product.images.isNotEmpty) {
